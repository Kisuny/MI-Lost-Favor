ClientEvents.lang('ru_ru', event => {
    ...
    event.add('milf.how_to_get_blaze_core.tooltip', 'Можно получить с шансом 50% если убить ключом: The Black Charro, Umvuthi, Frostmaw, Ferrous Wroughtnaut, Amethyst Crab')
    ...
    event.add('milf.soul_harvest.tooltip', 'Собирает <magic>осколки душ</magic> с убитой <keyword>нежити</keyword>')
...
Получит награду куда выше, чем ты.`)
    ...
    event.add('milf.emi_info.gem_dust', "<keyword>Метод наковальни</keyword>: бросьте самоцвет на землю и уроните <property>наковальню</property> прямо на него, чтобы раздробить его в пыль. <warning>Учтите, что этот ранний способ даёт только одну пыль с одного самоцвета</warning>")
