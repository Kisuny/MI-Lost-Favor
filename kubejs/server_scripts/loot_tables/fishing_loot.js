LootJS.lootTables(event => {
    event
        ...
        .createPool(pool => {
            ...
            pool.addEntry(LootEntry.of("endrem:fishing_eye").withWeight(5))
            pool.addEntry(LootEntry.of("endrem:undead_eye").withWeight(5))
            pool.addEntry(LootEntry.of("endrem:magical_eye").withWeight(5))
            pool.addEntry(LootEntry.of("endrem:lost_eye").withWeight(5))
            pool.addEntry(LootEntry.of("endrem:guardian_eye").withWeight(5))
            pool.addEntry(LootEntry.of("endrem:exotic_eye").withWeight(5))
            pool.addEntry(LootEntry.of("endrem:cryptic_eye").withWeight(5))
