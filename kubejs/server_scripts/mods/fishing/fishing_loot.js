LootJS.lootTables(event => {
    ...
    event
        ...
        .createPool(pool => {
            pool.addEntry(
                LootEntry.reference("minecraft:gameplay/fishing/treasure").withWeight(1088) // main loot table - 80%
            )
            ...
            pool.addEntry(LootEntry.of("enigmaticlegacyplus:earth_heart_fragment").withWeight(50))
            pool.addEntry(LootEntry.of("endrem:fishing_eye").withWeight(10))
            pool.addEntry(LootEntry.of("endrem:undead_eye").withWeight(10))
            pool.addEntry(LootEntry.of("endrem:magical_eye").withWeight(10))
            pool.addEntry(LootEntry.of("endrem:lost_eye").withWeight(10))
            pool.addEntry(LootEntry.of("endrem:guardian_eye").withWeight(10))
            pool.addEntry(LootEntry.of("endrem:exotic_eye").withWeight(10))
            pool.addEntry(LootEntry.of("endrem:cryptic_eye").withWeight(10))
            pool.addEntry(LootEntry.of("aquaculture:neptunium_axe").withWeight(5))
            pool.addEntry(LootEntry.of("aquaculture:neptunium_pickaxe").withWeight(5))
            pool.addEntry(LootEntry.of("aquaculture:neptunium_shovel").withWeight(5))
            pool.addEntry(LootEntry.of("aquaculture:neptunium_hoe").withWeight(5))
            pool.addEntry(LootEntry.of("aquaculture:neptunium_sword").withWeight(5))
            pool.addEntry(LootEntry.of("aquaculture:neptunium_helmet").withWeight(5))
            pool.addEntry(LootEntry.of("aquaculture:neptunium_chestplate").withWeight(5))
            pool.addEntry(LootEntry.of("aquaculture:neptunium_leggings").withWeight(5))
            pool.addEntry(LootEntry.of("aquaculture:neptunium_boots").withWeight(5))
            pool.addEntry(LootEntry.of("aquaculture:neptunium_fillet_knife").withWeight(5))
            pool.addEntry(LootEntry.of("aquaculture:neptunium_bow").withWeight(5))
            pool.addEntry(LootEntry.of("enigmaticlegacyplus:mending_mixture").withWeight(5))
            pool.addEntry(LootEntry.of("enigmaticlegacyplus:earth_heart").withWeight(5))
