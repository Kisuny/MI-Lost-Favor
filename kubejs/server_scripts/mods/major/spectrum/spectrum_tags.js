ServerEvents.tags('item', event => {
    ...
    event.add('milf:notched_polished_block', [
        'spectrum:notched_polished_basalt',
        'spectrum:notched_polished_calcite',
    ]);

    event.add('milf:gemstone_lamp', [
    ...
    event.add('milf:phantom_frame', [
        'spectrum:phantom_frame',
        'spectrum:glow_phantom_frame',
    ]);

    event.add('milf:colored_lamp', [
    ...
    event.add('milf:colored_spore_blossom', [
        'spectrum:white_spore_blossom',
        ...
        'spectrum:gray_spore_blossom',
        'spectrum:light_gray_spore_blossom',
    ...
    event.add('milf:colored_glowblock', [
    ...
    event.add('milf:item_bowl', [
        'spectrum:item_bowl_calcite',
        'spectrum:item_bowl_basalt',
    ]);

    event.add('milf:azure_dike_trinkets', [
    ...
    event.add('milf:onyx_chiseled_block', [
        'spectrum:onyx_chiseled_basalt',
        'spectrum:onyx_chiseled_calcite',
    ]);

    event.add('milf:chiseled_base_blocks', [
        'spectrum:chiseled_polished_basalt',
        'spectrum:chiseled_polished_calcite',
    ]);

    event.add('milf:pillar_base_blocks', [
        'spectrum:polished_calcite_pillar',
        'spectrum:polished_basalt_pillar',
    ]);

    event.add('milf:polished_base_blocks', [
        'spectrum:polished_basalt',
        'spectrum:polished_calcite',
    ]);

    event.add('milf:moonstone_chiseled_base_blocks', [
        'spectrum:moonstone_chiseled_basalt',
        'spectrum:moonstone_chiseled_calcite',
    ]);

    event.add('milf:crest_base_blocks', [
        'spectrum:polished_calcite_crest',
        'spectrum:polished_basalt_crest',
    ]);

    event.add("spectrum:gemstone_powder_blocks", [
        'spectrum:topaz_powder_block', 
        'spectrum:amethyst_powder_block', 
        'spectrum:citrine_powder_block', 
