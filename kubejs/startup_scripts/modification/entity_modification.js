...
const mythsandlegends_mobs = [
    ...
    "mythsandlegends:cogling",
    "mythsandlegends:draugr",
    "mythsandlegends:eidolon",
    "mythsandlegends:jiangshi",
    "mythsandlegends:shade_jelly",
    "mythsandlegends:omecuaime",
    "mythsandlegends:possessed_armor_lancer",
