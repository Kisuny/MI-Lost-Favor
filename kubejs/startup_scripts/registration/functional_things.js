...
//     },
//     {
//         name:"machine_assembler",
//         langPlacers: { "en_us": `Basic Machine Assembler ${en_usPlacer}`},
//         langBoxes: { "en_us": `Basic Machine Assembler ${en_usEmptyBox}`},
//         mod:"mi_tweaks",
//         activeMachineShape: 0
//     },
//     {
//         name: ["machine_assembler_shape_1", "machine_assembler"],
//         langPlacers: { "en_us": `Advanced Machine Assembler ${en_usPlacer}` },
//         langBoxes: { "en_us": `Advanced Machine Assembler ${en_usEmptyBox}` },
//         mod: "mi_tweaks",
//         activeMachineShape: 1
//     },
//     // {
...
//     })
//     global.PLACER_BLOCK_TO_ITEM_NAME_MAP[`milf:${nameString}_placer`] = `${template.mod}:${itemName}`
...
//     })
//     global.EMPTY_BOX_BLOCK_TO_ITEM_NAME_MAP[`milf:${nameString}_empty_box`] = `${template.mod}:${itemName}`
// })
