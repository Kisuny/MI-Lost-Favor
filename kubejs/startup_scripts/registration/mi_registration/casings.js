MIMachineEvents.registerCasings(event => {
    ...
    event.registerBlockImitation("light_engineering", "immersiveengineering:light_engineering")
    event.registerBlockImitation("heavy_engineering", "immersiveengineering:heavy_engineering")
    event.registerBlockImitation("rs_engineering", "immersiveengineering:rs_engineering")
    event.registerBlockImitation("resonanz_engineering", "immersiveengineering:resonanz_engineering")
    ...
    event.registerBlockImitation("machine_plating_block", "oritech:machine_plating_block")
    event.registerBlockImitation("carbon_plating_block", "oritech:carbon_plating_block")
    event.registerBlockImitation("machine_core_3", "oritech:machine_core_3")
    

    event.registerBlockImitation("chart_crate", "milf:embers_dummy_chart_block_crate")
    ...
    event.registerBlockImitation("reinforced_steel_machine_casing", "modern_industrialization:reinforced_steel_machine_casing")
